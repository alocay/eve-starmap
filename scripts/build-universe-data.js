...
// jsonl tables individually — only two small parts of that zip end up in the output file.
...
async function main() {
  ...
  console.log(`Downloaded ${zipBuffer.length} bytes, extracting mapSolarSystems.jsonl and mapStargates.jsonl ...`)

  const entries = extractFromZip(zipBuffer, new Set(['mapSolarSystems.jsonl', 'mapStargates.jsonl']))
